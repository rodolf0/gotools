...
func Aggregate(input <-chan stream.Line, delim []byte, aggspec AggSpec) map[string][]Aggregator {
...
func Print(aggregations map[string][]Aggregator, delim []byte, out io.Writer) {
